...
from models.function import normal
from models.function import calc_mean_std


class TMamba(nn.Module):
    
    def __init__(self,encoder, ke_block, decoder, patchEmbed, mamba,args):
    ...
    def forward(self, samples_c: NestedTensor,samples_s: NestedTensor):
        ...
        hs_ke = self.ke_blocks(hs)
        Ics = self.decode(hs + 0.1 * hs_ke)
